...
#define FINISH_ACK_MESSAGE_COUNT                "FINISH_ACK_MESSAGE_COUNT"
#define DISTRIBUTED_RESPONSE_MESSAGE_COUNT      "DISTRIBUTED_RESPONSE_MESSAGE_COUNT"
...
enum count_metric {
    ...
    FINISH_ACK_MESSAGE_COUNT_,
    DISTRIBUTED_RESPONSE_MESSAGE_COUNT_,
