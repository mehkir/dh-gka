...
class str_dh : public key_agreement_protocol, public multicast_application_impl {
    ...
    private:
        ...
        std::unordered_map<service_id_t, std::unique_ptr<tg_key_tree>> tg_key_tree_map_;
    ...
    private:
        ...
        std::unique_ptr<tg_key_tree> build_tg_tree(CryptoPP::Integer _group_secret, CryptoPP::Integer _blinded_group_secret,
